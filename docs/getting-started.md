...
Install Frappe Inspector from VS Code Marketplace, Open VSX or the [public VSIX release](https://github.com/Belius303/frappe-inspector-support/releases/download/cross-platform-v1.0.1/frappe-inspector-vscode-1.0.1.vsix). In VS Code or Cursor, run **Extensions: Install from VSIX**, then open the Frappe Inspector Activity Bar view and run **Frappe Inspector: Scan Project**.
...
```shell
npm install --global https://github.com/Belius303/frappe-inspector-support/releases/download/cross-platform-v1.0.1/frappe-inspector-cli-1.0.1.tgz
```
...
```shell
npm install --global https://github.com/Belius303/frappe-inspector-support/releases/download/cross-platform-v1.0.1/frappe-inspector-mcp-1.0.1.tgz
```
