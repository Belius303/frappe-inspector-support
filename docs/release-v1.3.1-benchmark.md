# Frappe Inspector 1.3.1 Benchmark Release

This release publishes the Frappe-specific benchmark evidence and the 1.3.1 Node-client messaging for VS Code/Cursor, CLI, MCP and the GitHub Action.
