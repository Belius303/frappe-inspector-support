...
Current npm package: [`@frappe-inspector/mcp`](https://www.npmjs.com/package/@frappe-inspector/mcp), version **1.3.2**.
...
| `review_frappe_pull_request` | Community | Refresh the working tree and return a contextualized Markdown/JSON PR review |
| `review_frappe_migration_plan` | Pro | Compare a Git baseline and return a migration-focused Markdown/JSON review |
